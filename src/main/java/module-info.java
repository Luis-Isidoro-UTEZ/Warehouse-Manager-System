module mx.edu.utez.warehousemanagerfx {
    ...
    opens mx.edu.utez.warehousemanagerfx.controllers.register to javafx.fxml;
    exports mx.edu.utez.warehousemanagerfx.controllers.register;
    ...
    opens mx.edu.utez.warehousemanagerfx.controllers.inf to javafx.fxml;
    exports mx.edu.utez.warehousemanagerfx.controllers.inf;
}