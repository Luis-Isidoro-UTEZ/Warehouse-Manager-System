...
CREATE TABLE USER_ACCOUNT (
    ...
    Role_Type VARCHAR2(20) NOT NULL CHECK (Role_Type IN ('SUPERADMINISTRATOR', 'ADMINISTRATOR'))
);

-- SUPERADMIN subtype of USER
CREATE TABLE SUPERADMINISTRATOR (
    Id_SuperAdmin NUMBER PRIMARY KEY,
    CONSTRAINT fk_superadmin_user FOREIGN KEY (Id_SuperAdmin) REFERENCES USER_ACCOUNT (Id_User) ON DELETE CASCADE
);
...
CREATE TABLE ADMINISTRATOR (
    ...
    Id_Branch NUMBER,
    Is_Deleted NUMBER(1) DEFAULT 0 NOT NULL,
    CONSTRAINT fk_admin_user FOREIGN KEY (Id_Admin) REFERENCES USER_ACCOUNT (Id_User) ON DELETE CASCADE,
...
CREATE TABLE WAREHOUSE (
    ...
    Warehouse_Code VARCHAR2(20) UNIQUE,
    Warehouse_Registration_Date DATE NOT NULL,
    Warehouse_Name VARCHAR2(100) NOT NULL,
    Image VARCHAR2(255) DEFAULT 'ImageNotAvailable.jpg',
    Rental_Price NUMBER(12,2) NOT NULL,
    Sale_Price NUMBER(12,2) NOT NULL,
    Size_Sq_Meters NUMBER(8,2) NOT NULL,
    Status VARCHAR2(20) DEFAULT 'Available' NOT NULL CHECK (Status IN ('Available', 'Rented', 'Sold', 'Rent Only', 'Sale Only')),
    Is_Deleted NUMBER(1) DEFAULT 0 NOT NULL,
    ...
    CONSTRAINT fk_warehouse_client FOREIGN KEY (Id_Client) REFERENCES CLIENT (Id_Client)
);
...
CREATE TABLE WAREHOUSE_TRANSACTION (
    ...
    Transaction_Type VARCHAR2(5) NOT NULL CHECK (Transaction_Type IN ('Sale', 'Rent')),
    ...
    CONSTRAINT fk_trans_admin FOREIGN KEY (Id_Admin) REFERENCES ADMINISTRATOR (Id_Admin)
);
